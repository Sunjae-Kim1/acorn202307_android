...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestBtn.setOnClickListener(view -> {
            ...
            // 2. HTTP 요청을 하고
            new RequestTask().execute(url); // 이 메소드는 호출 즉시 리턴

            // 3. 정상적으로 응답되면 응답된 문자열을 EditText 에 출력
    ...
    class RequestTask extends AsyncTask<String , Void , String> {
        ...
        // BackGround ( 새로운 Thread 의 run() 메소드 ) 에서 작업할 내용을 이 메소드에서 작업하면 된다.
        @Override
        protected String doInBackground(String... strings) {
            ...
            // 몇 초의 시간을 소비해서 얻어낸 결과
            // String result = "<div>hello</div>";

            // 여기는 UI Thread 가 아니기 때문에 UI 업데이트 불가
